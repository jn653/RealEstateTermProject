...
namespace RealEstateTermProject
{
    public partial class RequestedSellings : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            String strSQL = "SELECT * FROM TP_Houses";
        ...
        protected void gvRequestors_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if( e.CommandName == "Select")
            {
                ...
                txtProperty.Text = row.Cells[2].Text;
                txtGarage.Text = row.Cells[6].Text;
                txtBedrooms.Text = row.Cells[4].Text;
                txtBathrooms.Text = row.Cells[13].Text;
                txtCity.Text = row.Cells[14].Text;
                txtAmentities.Text = row.Cells[10].Text;
